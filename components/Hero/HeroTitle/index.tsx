...
const HeroTitle: React.FC<Props> = (props) => {
  return (
    <div className="flex flex-col grow sm:min-w-[700px] justify-end sm:justify-start items-center sm:items-start">
			...
			<Image src={'/loocale-mini-logo.png'} width={100} height={70} alt='logo' layout="fixed"></Image>
			</div>
      <h1 className="font-bold sm:text-[68px] text-[36px] text-white sm:mb-4">{props.title}</h1>
