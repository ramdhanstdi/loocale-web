...
const SHARE_LIST = [
	{
		...
		story: 'Pulau Dolphin di Kepulauan Seribu bikin lupa kalau kita masih di Jakarta! Cuma 3 jam dari Ibukota cocok banget buat jadi tempat hiburan untuk lupain kehidupan serba padat di kota. Recommended banget!',
	...
	},
	{
		...
		username: '@Erikkkkk',
		story: 'USS Shipwreck di Tulamben emang diving site terbaik yang WAJIBBB didatengin sama setiap orang yang hobi diving!Selain shipwreck, banyak juga ikan sama coral yang hidup di sekitarnya, worth to try!',
	...
	},
	{
		...
		username: '@askaradid',
		story: 'Makhluk sepanjang 3 meter, ganas, bersisik ini hanya ada di lima pulau Indonesia – Padar, Gili Motang, Flores, Rinca dan secara alami, Komodo. Komodo ini benar-benar menakutkan sekaligus menakjubkan!',
	...
	},
	{
		displayName: 'Daniel',
		username: '@DanielRwn',
		story: 'Terbaik emang abis lari pagi mampir di Tegallalang. Udah viewnya cakep udaranya seger banget lagi! ',
...
const ShareHome = () => {
	...
	useEffect(() => {
		setShownCards(SHARE_LIST.slice(carouselStartIndex, window.innerWidth > 1100 ? 2 : 1))
